# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 12:25:38 2020
...
flags.DEFINE_integer('input_shape', 625 , 'The inputs tensor shape')
...
numpy_imgs = resized_images.numpy()
im=tf.reshape(numpy_imgs, [55000,625])
imf=im.numpy()
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            for step in range(max_steps):
                ...
                train_feed_dict = {images_pl: training_data, labels_pl: training_label}
