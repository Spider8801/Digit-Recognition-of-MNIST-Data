...
def train(FLAGS):
    ...
    with tf.Graph().as_default():
        ...
        saver = tf.train.import_meta_graph('C:/Users/KIIT/Anaconda3/envs/tensorflow_env/MNIST-AlexNet-Using-Tensorflow-master/outputs/model/model.ckpt-299.meta')
        ...
        with tf.Session() as sess:
            saver.restore(sess,'C:/Users/KIIT/Anaconda3/envs/tensorflow_env/MNIST-AlexNet-Using-Tensorflow-master/outputs/model/model.ckpt-299')
